      ...
      <div class="social-links">
        ...
        <a href="mailto:zhan2374@msu.edu" title="Email">
          <svg viewBox="0 0 24 24" width="24" height="24">
            <!-- 移除 fill="#4285F4"，让颜色由 CSS 继承 -->
            <path d="M3 4a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4Zm2 0v.01L12 9.51 17 4.01V4H5Zm0 2.62V18h14V6.62l-5.99 4.68a1 1 0 0 1-1.24 0L5 6.62Z"/>
          </svg>
        </a>
        ...
        <a href="https://scholar.google.com.hk/citations?user=kEJINEIAAAAJ"
          ...
          <svg viewBox="0 0 512 512" width="24" height="24" aria-label="Google Scholar" role="img">
            <!-- 移除 fill="#4285F4" 和 fill="#FFFFFF"，让颜色由 CSS 继承 -->
            <rect width="512" height="512" rx="15%"/>
            <path d="M213 111l-107 94h69c5 45 41 64 78 67-7 18-4 27 7 39-43 1-103 26-103 67
